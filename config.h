...
static const char *altbarcmd        = "$HOME/.config/polybar/colorblocks/launch.sh"; /* Alternate bar launch command */
static const char *fonts[] = {"VictorMono  :size=20"};
static const char dmenufont[] = "VictorMono:size=20";
static const char col_gray1[] = "#000000";
static const char col_gray2[] = "#000000";
static const char col_gray3[] = "#5F5F00";
static const char col_gray4[] = "#00FF00";
// static const char col_cyan[]        = "#00CCFF";
...
static const Rule rules[] = {
    ...
    {"wezterm"                , NULL    , NULL      , 1  , 0,       1,        -1},
    {"st"                     , NULL    , NULL      , 1  , 0,       0,         1},
    {"wireshark"              , NULL    , NULL      , 1  , 0,       0,        -1},
